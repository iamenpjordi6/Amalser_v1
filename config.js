...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'MilfBOT' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'MilfBOT' : process.env.BOT_NAME,
    ...
    PLKBGM: process.env.CHANGE_BGM_TO === undefined ? 'false' : process.env.CHANGE_BGM_TO,
    PROMOTEMSG: process.env.PROMOTE_MESSAGE === undefined ? 'default' : process.env.PROMOTE_MESSAGE,
    DEMOTEMSG: process.env.DEMOTE_MESSAGE === undefined ? 'default' : process.env.DEMOTE_MESSAGE,
    BANMSG: process.env.BAN_MESSAGE === undefined ? 'default' : process.env.BAN_MESSAGE,
    AFKMSG: process.env.AFK_MESSAGE === undefined ? 'default' : process.env.AFK_MESSAGE,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Milf' : process.env.TAG_HEADER,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '917428849575,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
